...
- Wire `onMutate` snapshot and `onError` restore in every optimistic mutation — even single-field patches — before the feature is considered production-ready; deferred rollback wiring is the most common form of silent reliability debt in TanStack Query integrations.
...
| Deferred rollback wiring = silent reliability debt in LabelColorPicker | [reflection-TASK-013.md](../reflection/reflection-TASK-013.md) | 2026-06-27 |
